...
public class RandomCharacter {
	...
	public static void main(String[] args) {
		...
		for (sequenceOfCharacter = 'A'; sequenceOfCharacter <= 'Z'; sequenceOfCharacter++) {
			...
			// check comparison and equality of vowels
			if (sequenceOfCharacter != 'A' || sequenceOfCharacter != 'E' || sequenceOfCharacter != 'I'
					|| sequenceOfCharacter != 'O' || sequenceOfCharacter != 'U')
				break;
		}
