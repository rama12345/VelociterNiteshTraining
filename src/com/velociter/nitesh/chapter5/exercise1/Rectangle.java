...
public class Rectangle {
	...
	public Rectangle(Point tl, Point br) {// top-Left or Bottom-right
	...
	public Rectangle encloses(Rectangle rect) {
		// Return a new rectangle defined by the minimum x,y for to left and the and
		// maximum x,y for bottom right
		return new Rectangle(Math.min(topLeft.getX(), rect.topLeft.getX()), Math.min(topLeft
				.getY(), rect.topLeft.getY()), Math.max(bottomRight.getX(), rect.bottomRight.getX()),
