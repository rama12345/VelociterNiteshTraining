...
public class BankOperation {
	public static void main(String[] args) {
		...
		for (int i = 1; i <= transactionCount; i++) {
			...
			transaction = new Transaction(accounts[select], Transaction.CREDIT, amount); // Account Credit transaction of amount
			...
			transaction = new Transaction(accounts[select], Transaction.DEBIT, amount);// Account Debit transaction of amount
